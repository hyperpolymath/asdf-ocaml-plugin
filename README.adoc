...
:url-repo: https://github.com/hyperpolymath/asdf-ocaml-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-ocaml-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-ocaml-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-ocaml-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Ocaml] versions.
...
Ocaml is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Ocaml versions per project

|**Project Isolation**
|Pin Ocaml per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Ocaml version
...
=== Installing Ocaml Versions

[source,bash]
----
asdf list all ocaml
asdf install ocaml latest
asdf install ocaml 0.1.0
----
...
[source,bash]
----
asdf global ocaml 0.1.0
asdf local ocaml 0.1.0
asdf current ocaml
ocaml --version
----
...
* Ensure `ocaml` is on PATH after installation.
* Verify the installed version with `ocaml --version`.
